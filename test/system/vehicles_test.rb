...
class VehiclesTest < ApplicationSystemTestCase
  ...
  test "creating a Vehicle" do
    ...
    fill_in "N°Cin", with: @vehicle.n°cin
    fill_in "N°Engines", with: @vehicle.n°engines
    fill_in "Owner Names", with: @vehicle.owner_names
    fill_in "Vehicules Type", with: @vehicle.vehicules_type
